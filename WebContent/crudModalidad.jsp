										...
										<tbody>
												...
												<c:forEach items="${lstModalidad}" var="x">
													<tr>
														...
														<td>
															<button type='button' data-toggle='modal' onclick="editar('${x.idModalidad}','${x.nombre}','${x.numHombres}','${x.numMujeres}','${x.edadMaxima}','${x.edadMinima}','${x.sede}','${x.deporte.idDeporte}');" class='btn btn-success' style='background-color:hsla(233, 100%, 100%, 0);'>
  	 ...
  	 <div class="modal fade" id="idModalRegistra" >
			<div class="modal-dialog" style="width: 60%">
				...
				<div class="modal-body" style="padding: 20px 10px;">
						<form id="id_form_registra" accept-charset="UTF-8" action="registraModalidad" class="form-horizontal"     method="post">
		                            ...
		                            <div id="stepOne" class="panel-collapse collapse in">
		                                <div class="panel-body">
		                                    ...
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_reg_minima" name="modalidad.edadMinima" placeholder="Ingrese la edad mínima" type="text" maxlength="2"/>
		                                        </div>
		                                    </div> 
		                                    <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_reg_sede">Sede</label>
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_reg_sede" name="modalidad.sede" placeholder="Ingrese la sede" type="text" maxlength="40"/>
		                                        </div>
		                                    </div>    
		                                    <div class="form-group">
		 ...
		 <div class="modal fade" id="idModalActualiza" >
			<div class="modal-dialog" style="width: 60%">
				...
				<div class="modal-body" style="padding: 20px 10px;">
						<form id="id_form_actualiza" accept-charset="UTF-8"  action="actualizaModalidad" class="form-horizontal"     method="post">
		                    <div class="panel-group" id="steps">
		                        <!-- Step 1 -->
		                        <div class="panel panel-default">
		                            <div class="panel-heading">
		                                ...
		                                <div class="panel-body">
		                                    <div class="form-group">
		                                     ...
		                                     <div class="form-group">
		                                        ...
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_act_nombre" name="modalidad.nombre" placeholder="Ingrese el Nombre" type="text" maxlength="20"/>
		                                        </div>
		                                    </div>
		                                    <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_act_num_hombres"># Hombres</label>
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_act_num_hombres" name="modalidad.numHombres" placeholder="Ingrese el número de hombres" type="text" maxlength="2"/>
		                                        </div>
		                                    </div>
		                                    <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_act_num_mujeres"># Mujeres</label>
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_act_num_mujeres" name="modalidad.numMujeres" placeholder="Ingrese el número de mujeres" type="text" maxlength="2"/>
		                                        </div>
		                                    </div>		   
		                                    <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_act_maxima">Edad Máxima</label>
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_act_maxima" name="modalidad.edadMaxima" placeholder="Ingrese la edad máxima" type="text" maxlength="2"/>
		                                        </div>
		                                    </div>   
		                                    <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_act_minima">Edad Mínima</label>
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_act_minima" name="modalidad.edadMinima" placeholder="Ingrese la edad mínima" type="text" maxlength="2"/>
		                                        </div>
		                                    </div> 
		                                    <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_act_sede">Sede</label>
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_act_sede" name="modalidad.sede" placeholder="Ingrese la sede" type="text" maxlength="40"/>
		                                        </div>
		                                    </div>    
		                                    <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_act_deporte">Deporte</label>
		                                        <div class="col-lg-5">
													<select id="id_act_deporte" name="modalidad.deporte.idDeporte" class='form-control'>
							                            	<option value=" ">[Seleccione]</option>    
							                         </select>
		                                        </div>
		                                    </div>
        ...
        fields: {
            ...
            "modalidad.sede": {
                ...
                validators: {
                    ...
                    stringLength :{
                    	message:'La sede es de 5 a 40 caracteres',
                    	min : 5,
                    	max : 100
                    }
                }
            },
            "modalidad.deporte.idDeporte": {
